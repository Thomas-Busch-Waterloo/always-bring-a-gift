...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ChannelHealth>
 */
class ChannelHealthFactory extends Factory
{
    protected $model = ChannelHealth::class;
