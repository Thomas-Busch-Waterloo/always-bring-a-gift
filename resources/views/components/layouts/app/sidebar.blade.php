    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Gift Tracking')" class="grid">
                    ...
                    <flux:navlist.item icon="calendar" :href="route('events.past')" :current="request()->routeIs('events.past')" wire:navigate>{{ __('Past Events') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
